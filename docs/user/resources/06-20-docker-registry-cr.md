...
| **internalAccess.secretName**                        | string     | Name of Secret with data needed for internal connection to Docker Registry.                                                                                                                                                                                                                                                                                    |
| **internalAccess.pushAddress**                       | string     | Address that can be used to push images from inside the cluster.                                                                                                                                                                                                                                                                                               |
| **internalAccess.pullAddress**                       | string     | Address that can be used by Kubernetes to make a communication with registry.                                                                                                                                                                                                                                                                                  |
...
| **externalAccess.secretName**                        | string     | Name of Secret with data needed for external connection to Docker Registry.                                                                                                                                                                                                                                                                                    |
| **externalAccess.pushAddress**                       | string     | Address that can be used to push images from outside the cluster.                                                                                                                                                                                                                                                                                              |
| **externalAccess.pullAddress**                       | string     | Address that can be used by Kubernetes to make a communication with registry.                                                                                                                                                                                                                                                                                  |
